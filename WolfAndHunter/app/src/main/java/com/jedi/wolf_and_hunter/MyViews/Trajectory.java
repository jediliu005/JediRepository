...
public class Trajectory extends View {
    Point fromPointRelateParent;
    Point toPointRelateParent;
    Point fromPointForDraw;
    Point toPointForDraw;
    ...
    public Trajectory(Context context,Point fromPoint, Point toPoint) {
        super(context);
