...
public class SpecailButton extends android.support.v7.widget.AppCompatTextView implements View.OnClickListener {
...
//        paint.setTextSize(textSize);
    ...
    public void onClick(View v) {
        checked = !checked;
        setBackgroundResource(checked ? 0 : R.drawable.normal_field );
        if (mListener != null) {
